...
// (fixtures de usuario/media), no en codigo de produccion del handler; el
// runtime no distingue modulos de test.
...
mod tests {
    ...
    async fn test_state() -> AppState {
        ...
        AppState {
            ...
            api_rate_limit: Arc::new(Mutex::new(
                HashMap::<String, (u32, std::time::Instant)>::new(),
            )),
